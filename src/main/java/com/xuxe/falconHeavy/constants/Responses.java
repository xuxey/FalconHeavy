...
public class Responses {
    ...
    public static final String NO_BOT_PERMISSION = "Looks like I am missing the following permissions(s): ";
    ...
    public static final String CHANNEL_DISABLED_COMMAND = "This command is disabled in this channel.";
